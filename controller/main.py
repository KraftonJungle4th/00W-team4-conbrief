...
from clientConfigs.main.CONFIGS import SEARCH_CONFIG, INFO_CONFIG
...
def main(studentNo: str):
    ...
    if request.method == 'POST':
        ...
        return render_template('main/main.html', SEARCH_CONFIG=SEARCH_CONFIG, RESULT=RESULT, INFO_CONFIG=INFO_CONFIG)
